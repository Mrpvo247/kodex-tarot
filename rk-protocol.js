...
window.RKProtocol = (() => {
  ...
  const insights = {
    ...
    "The Fool": {
      ...
      "ShadowIntegration×Rubedo": "Your inner fool, once integrated, becomes the spark that ignites every future breakthrough—spontaneity becomes strategic innovation."
    },
    "Eight of Pentacles": {
